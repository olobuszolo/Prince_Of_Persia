...
class Block(pygame.sprite.Sprite):
    """This is implementation of  basic block."""
...
class Gate(pygame.sprite.Sprite):
    """On  the final level when boss is killed gate is opened and main character has access to door. """
    def __init__(self, game, x, y):
        self.game = game
        self._layer = BLOCK_LAYER
...
class FallingLeft(pygame.sprite.Sprite):
    """
    This is implementation of falling bricks which get damages during collision with character. 
    They are use when main character will be approaching from left side. It is used as abstract class.
    """
    def __init__(self, game, x, y):
        self.game = game
        self._layer = BLOCK_LAYER
...
class FallingLeftBottomUp(FallingLeft):
    """Falling bricks- they are activate when we approach to them fron the left side and going from bottom to top."""
    def __init__(self, game, x, y):
        super().__init__(game, x, y)
    def activate(self):
        player_y = self.game.player.rect.y
...
class SemiDoors(pygame.sprite.Sprite):
    """Implementation of invisible 'door'- it is used when we change level on sub_level."""
    def __init__(self, game, x, y):
        super().__init__()
        self.game = game
        self._layer = BLOCK_LAYER
...
class Protection(Block):
    """When main character is on upper semi_level it prevents drawing back to previous level."""
    def __init__(self, game, x, y):
        super().__init__(game, x, y)
...
class NewTrap(pygame.sprite.Sprite):
    """
    When main character stands on trap it 'dissapear' but it is activated from one side- when main character stands on it- 
    this works as trap but when main character wants hits it from the bottom it works as block
    """
    def __init__(self, game, x, y):
        self.game = game
        self._layer = BLOCK_LAYER
